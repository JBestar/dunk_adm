...
function showMoneyHistory(jsonBetData) {
    ...
    for (nRow in jsonBetData) {
        ...
        switch (parseInt(jsonBetData[nRow].money_change_type)) {
            ...
            case 37: strBuf += "랜덤5분파워볼 배팅"; break;
            case 38: strBuf += "랜덤5분파워볼 배팅취소"; break;
            case 39: strBuf += "랜덤5분파워볼 정산"; break;
            case 40: strBuf += "랜덤3분파워볼 배팅"; break;
            case 41: strBuf += "랜덤3분파워볼 배팅취소"; break;
            case 42: strBuf += "랜덤3분파워볼 정산"; break;
