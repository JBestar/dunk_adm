        ...
        if (i % 2 == 0 || i > 7) {
            ...
            switch (i) {
                ...
                case 15:
                    ...
                    break;
                case 16:
                    strBuf += "슈퍼+파워조합: 슈퍼홀 파워홀배팅";
                    break;
                case 17:
                    strBuf += "슈퍼+파워조합: 슈퍼홀 파워짝배팅";
                    break;
                case 18:
                    strBuf += "슈퍼+파워조합: 슈퍼짝 파워홀배팅";
                    break;
                case 19:
                    strBuf += "슈퍼+파워조합: 슈퍼짝 파워짝배팅";
                    break;
                case 20:
                    strBuf += "슈퍼+파워조합: 슈퍼언더 파워언더배팅";
                    break;
                case 21:
                    strBuf += "슈퍼+파워조합: 슈퍼언더 파워오버배팅";
                    break;
                case 22:
                    strBuf += "슈퍼+파워조합: 슈퍼오버 파워언더배팅";
                    break;
                case 23:
                    strBuf += "슈퍼+파워조합: 슈퍼오버 파워오버배팅";
                    break;
                default:
                    break;
            }
