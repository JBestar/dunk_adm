...
function readConfigToObject() {
    ...
    //objMember.mb_money_charge = document.getElementById("useredit-charge-input-id").value;
    //objMember.mb_money_exchange = document.getElementById("useredit-exchange-input-id").value;
