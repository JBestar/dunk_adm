...
class EosRound_Model extends Model
{
    ...
    public function setType($gameId){
        if($gameId == GAME_EOS3_BALL)
            $this->table = 'round_eos3ball';
        else $this->table = 'round_eos5ball';
    }
    ...
    public function register($arrReqData)
    {
        ...
        // $this->db->set('round_fid', $arrReqData['round_fid']);
