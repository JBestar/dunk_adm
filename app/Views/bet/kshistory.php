...
<?= $this->section('history-active') ?>"키노사다리"<?= $this->endSection() ?>
<?= $this->section('history-title') ?>키노사다리 배팅내역<?= $this->endSection() ?>
...
<script src="<?php echo base_url('assets/js/kshistory-script.js?v=1');?>"></script>
<?= $this->endSection() ?>