...
<?= $this->section('eval_content') ?>
	...
	<div class="confsite-site-panel">
		...
		<div class="pbresult-list-div" style="padding-left:20px;">
			...
			<input type="checkbox" id="confev-autopress-check-id" style="zoom:130%; margin-top:0px;"><label style="font-size:14px; font-weight:normal; padding-left:2px; margin-top:-10px;"> 승인</label>
			<!-- 		
