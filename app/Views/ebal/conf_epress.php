...
<?= $this->section('eval_content') ?>
	...
	<div class="confsite-site-panel" style="display: flex;">
		<div style="flex:35%;  float:left;">
			<h4><i class="glyphicon glyphicon-hand-right"></i> 자동누르기 설정</h4>

			<div class="confsite-game-text-div" style="margin-top:30px;">
				<p style="width:120px;">자동누르기:</p> 
			...
			<div class="confsite-game-text-div">
				<p style="width:120px;">배팅시간:</p> 
				<input type = "number" class="conf-text-input" style="min-width:150px;" id="confev-bettime-input-id" min="0" step="1">&nbsp;&nbsp;시간
			</div>
			<div class="confsite-game-text-div">
				<p style="width:120px;">보유금액:</p> 
				<input type = "number" class="conf-text-input" style="min-width:150px;" id="confev-moneypercent-input-id" min="0" step="1">&nbsp;&nbsp;%이하
			</div>
			<div class = "confsite-button-group" style="padding-left:30px;">
				<button class="confsite-cancel-button"  id="confsite-cancel-btn-id">취소</button>
				<button class="confsite-ok-button" id="confsite-ok-btn-id">저장</button>
			</div>
		</div>

		<div style="flex:65%; float:right;">
