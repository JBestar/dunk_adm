...
<!--Sub Navbar-->
	<div class = "sub-navbar">
		...
		<a href="<?php echo base_url().'home/conf_bogleball';?>" class="sub-navbar-a active" >보글파워볼</a>
	...
	<div class="confsite-game-panel">
		<!---->
		<h4><i class="glyphicon glyphicon-hand-right"></i> 보글파워볼 게임관련 설정</h4>	
...
<script src="<?php echo base_url('assets/js/confbb-script.js');?>"></script>
<?= $this->endSection() ?>