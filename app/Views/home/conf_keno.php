<?= $this->extend('/home/conf_game') ?>
	...
	<?= $this->section('confgame-content') ?>
		...
		<div class="confsite-game-text-div">
  		...
  		<div class="confsite-game-text-div">
  			<p style="font-size: 16px; font-weight: bold;">슈퍼볼조합</p>
	...
	<?php endif ?>
		<div class="confsite-game-text-div">
  			<p style="font-size: 16px; font-weight: bold;">숫자합</p>
  		</div>
		<div class="confsite-game-text-div">
  			<div>
  				<p>숫자합 홀 :: 짝 배당율</p>
