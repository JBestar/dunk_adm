...
<!--Sub Navbar-->
	...
	<?php if(is_null($objRound)) {  ?>
		<p><i class="glyphicon glyphicon-book"></i> 게임결과::보글사다리 회차 등록</p>
	<?php } else {?>
		<p><i class="glyphicon glyphicon-book"></i> 게임결과::보글사다리 회차 수정</p>
	<?php } ?>		
...
<!--main_navbar.php-->
	...
	<?php if(array_key_exists("app.produce", $_ENV)) :?>
		<script src="<?php echo base_url('/assets/js/bsresult_edit-script.js?t='.time());?>"></script>
	<?php else : ?>
		<script src="<?php echo base_url('/assets/js/bsresult_edit-script.js?v=1');?>"></script>
	<?php endif ?>
<?= $this->endSection() ?>