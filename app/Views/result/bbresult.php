...
<?= $this->section('bet-result-title') ?>보글볼<?= $this->endSection() ?>
...
<?php if(array_key_exists("app.produce", $_ENV)) :?>
	<script src="<?php echo base_url('/assets/js/bbresult-script.js?t='.time());?>"></script>
<?php else : ?>
	<script src="<?php echo base_url('/assets/js/bbresult-script.js?v=1');?>"></script>
<?php endif ?>
<?= $this->endSection() ?>