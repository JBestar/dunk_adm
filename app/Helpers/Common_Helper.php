<?php
    ...
    function allMoney($member){
      ...
      $nMoney = $member->mb_money + $member->mb_live_money + $member->mb_slot_money + $member->mb_fslot_money + $member->mb_kgon_money + $member->mb_gslot_money + $member->mb_hslot_money;
      return $nMoney;
    }
    ...
    function allEgg($member){
      ...
      $nMoney = $member->mb_live_money + $member->mb_slot_money + $member->mb_fslot_money + $member->mb_kgon_money + $member->mb_gslot_money + $member->mb_hslot_money;
      return $nMoney;
    }
